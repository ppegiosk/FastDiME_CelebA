...
def arguments():
    ...
    parser.add_argument('--gpu', default='0', type=str,
                        help='GPU id')
    parser.add_argument('--oracle-path', default='/scratch/ppar/models/oracle.pth', type=str,
                        help='Oracle path')
    ...
    parser.add_argument('--celeba-path', default='/scratch/ppar/data/img_align_celeba', type=str,
                        help='CelebA path')
